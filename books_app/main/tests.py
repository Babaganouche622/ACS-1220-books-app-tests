...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='Your Dad').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'Your Dad')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Awful').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'Awful')
    ...
    def test_favorite_book(self):
        ...
        new_response = self.app.get('/profile/me1')
    ...
    def test_unfavorite_book(self):
        ...
        new_response = self.app.get('/profile/me1')
        new_response_text = new_response.get_data(as_text=True)
        self.assertNotIn('To Kill a Mockingbird', new_response_text)
